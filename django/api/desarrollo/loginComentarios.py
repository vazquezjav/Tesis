...
class loginComentarios:
    ...
    def login(self, email, pas):
        ...
        browser = webdriver.Firefox(executable_path="C:\\Users\\vazqu\Desktop\\10mo\\Tesis\\Desarrollo\\django\\api\\desarrollo\\geckodriver-v0.29.1-win64\\geckodriver.exe", options=chrome_options)
